...
public class LoggingStopWatch extends StopWatch {
     ...
     * {@link net.jperf.log4j.JmxAttributeStatisticsAppender} in the logging configuration to be notified when
     ...
     * @see net.jperf.log4j.JmxAttributeStatisticsAppender#getNotificationThresholds()
     */
