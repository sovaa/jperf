...
import net.jperf.helpers.AcceptableRangeConfiguration;
...
public class JmxAttributeStatisticsAppender extends AppenderBase<LoggingEvent> {
     ...
     * MBeanServer. If not specified, defaults to net.jperf:type=StatisticsExposingMBean,name=Perf4J.
     *
     ...
     * {@link net.jperf.helpers.StatisticsExposingMBean} for more details.
     *
