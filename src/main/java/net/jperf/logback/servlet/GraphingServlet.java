 ...
 */
package net.jperf.logback.servlet;
...
import net.jperf.logback.GraphingStatisticsAppender;


/**
 * This graphing servlet implementation looks for graphs from {@link net.jperf.logback.GraphingStatisticsAppender}s that
...
public class GraphingServlet extends AbstractGraphingServlet {
     ...
     * {@link net.jperf.logback.GraphingStatisticsAppender#getAppenderByName(String)} method to find the appender with
     * the specified name.
     *
