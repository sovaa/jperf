 ...
 * {@link net.jperf.StopWatch} timing statements logged to an <tt>org.slf4j.Logger</tt>. Normally, though, if
 * logback is your logging framework of choice you should use the {@link net.jperf.slf4j.Slf4JStopWatch} as your
 * StopWatch implementation. Three appenders are provided:
 *
 * <ol>
 * <li>{@link net.jperf.logback.AsyncCoalescingStatisticsAppender} - This appender is used to group logged
 * <tt>StopWatch</tt> messages over a specified time span (defaults to 30 seconds) into single
 * {@link net.jperf.GroupedTimingStatistics} messages. Other appenders are designed to be attached to this
 ...
 * <li>{@link net.jperf.logback.JmxAttributeStatisticsAppender} - This appender, when attached to an
 ...
 * <li>{@link net.jperf.logback.GraphingStatisticsAppender} - This appender is used to output graphs (as a URL to the
 ...
 * a web server using a {@link net.jperf.logback.servlet.GraphingServlet} instance in concert with this class.
 * </ol>
 *
 ...
 *    --&gt;
 *    &lt;appender name="CoalescingStatistics" class="AsyncCoalescingStatisticsAppender"&gt;
 ...
 *    &lt;/appender&gt;
 *
 *    &lt;appender name="graphExecutionTimes" class="GraphingStatisticsAppender"&gt;
 ...
 *    &lt;/appender&gt;
 *
 *    &lt;appender name="graphExecutionTPS" class="GraphingStatisticsAppender"&gt;
 ...
 *      default.
 *    --&gt;
 *    &lt;appender name="perf4jJmxAppender" class="JmxAttributeStatisticsAppender"&gt;
 *        &lt;!--
 ...
 *          the default MBean name of net.jperf:type=StatisticsExposingMBean,name=Perf4J
 *        --&gt;
 *    &lt;/appender&gt;
 *
 ...
 *    &lt;!-- Loggers --&gt;
 *    &lt;!--
 *      The Perf4J logger. Note that net.jperf.TimingLogger is the value of the
 *      StopWatch.DEFAULT_LOGGER_NAME constant. Also, note that
