...
/**
 * This graphing servlet implementation looks for graphs from {@link net.jperf.log4j.GraphingStatisticsAppender}s that
...
public class GraphingServlet extends AbstractGraphingServlet {
     ...
     * {@link net.jperf.log4j.GraphingStatisticsAppender#getAppenderByName(String)} method to find the appender with
     * the specified name.
     *
