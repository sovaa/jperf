 ...
 * {@link net.jperf.StopWatch} timing statements logged to an <tt>org.apache.log4j.Logger</tt>. Normally, though, if
 * log4j is your logging framework of choice you should use the {@link net.jperf.log4j.Log4JStopWatch} as your
 * StopWatch implementation. Three appenders are provided:
 *
 * <ol>
 * <li>{@link net.jperf.log4j.AsyncCoalescingStatisticsAppender} - This appender is used to group logged
 ...
 * <li>{@link net.jperf.log4j.JmxAttributeStatisticsAppender} - This appender, when attached to an
 ...
 * <li>{@link net.jperf.log4j.GraphingStatisticsAppender} - This appender is used to output graphs (as a URL to the
 ...
 * a web server using a {@link net.jperf.log4j.servlet.GraphingServlet} instance in concert with this class.
 * </ol>
 *
 ...
 *   &lt;appender name="Perf4jJMX" class="JmxAttributeStatisticsAppender"&gt;
 *     &lt;param name="TagNamesToExpose" value="operation1,dbcall,servicecall"/&gt;
 *     &lt;param name="MBeanName" value="net.jperf.beans:type=Perf4J,name=ApplicationPerf"/&gt;
 *   &lt;/appender&gt;
 *
 *   &lt;!--
 *     This appender exposes mean execution times as a graph. You would most likely want to use
 *     a {@link net.jperf.log4j.servlet.GraphingServlet} (set up through a web.xml file) in addition to this appender
 *   --&gt;
 *   &lt;appender name="PageTimes" class="GraphingStatisticsAppender"&gt;
 ...
 *     with a {@link net.jperf.log4j.servlet.GraphingServlet}.
 *   --&gt;
 *   &lt;appender name="PageTPS" class="GraphingStatisticsAppender"&gt;
