 ...
 * allow you to specify the Logger to use (defaults to net.jperf.TimingLogger), the Level at which messages are
...
public class JavaLogStopWatch extends LoggingStopWatch {
     ...
     * with the name "net.jperf.TimingLogger" is used to log stop watch messages at the INFO level, or at the WARNING
