 ...
 * {@link org.jperf.StopWatch} timing statements logged to an <tt>org.slf4j.Logger</tt>. Normally, though, if
 * logback is your logging framework of choice you should use the {@link org.jperf.slf4j.Slf4JStopWatch} as your
 * StopWatch implementation. Three appenders are provided:
 *
 * <ol>
 * <li>{@link org.jperf.logback.AsyncCoalescingStatisticsAppender} - This appender is used to group logged
 * <tt>StopWatch</tt> messages over a specified time span (defaults to 30 seconds) into single
 * {@link org.jperf.GroupedTimingStatistics} messages. Other appenders are designed to be attached to this
 ...
 * <li>{@link org.jperf.logback.JmxAttributeStatisticsAppender} - This appender, when attached to an
 ...
 * <li>{@link org.jperf.logback.GraphingStatisticsAppender} - This appender is used to output graphs (as a URL to the
 ...
 * a web server using a {@link org.jperf.logback.servlet.GraphingServlet} instance in concert with this class.
 * </ol>
 *
 ...
 *    --&gt;
 *    &lt;appender name="CoalescingStatistics" class="org.jperf.logback.AsyncCoalescingStatisticsAppender"&gt;
 ...
 *    &lt;/appender&gt;
 *
 *    &lt;appender name="graphExecutionTimes" class="org.jperf.logback.GraphingStatisticsAppender"&gt;
 ...
 *    &lt;/appender&gt;
 *
 *    &lt;appender name="graphExecutionTPS" class="org.jperf.logback.GraphingStatisticsAppender"&gt;
 ...
 *      default.
 *    --&gt;
 *    &lt;appender name="perf4jJmxAppender" class="org.jperf.logback.JmxAttributeStatisticsAppender"&gt;
 *        &lt;!--
 ...
 *          the default MBean name of org.jperf:type=StatisticsExposingMBean,name=Perf4J
 *        --&gt;
 *    &lt;/appender&gt;
 *
 *    &lt;!-- This file appender is used to output aggregated performance statistics --&gt;
 *    &lt;appender name="perf4jFileAppender" class="ch.qos.logback.core.rolling.RollingFileAppender"&gt;
 *        &lt;File&gt;target/jperf.log&lt;/File&gt;
 *        &lt;encoder&gt;
 *            &lt;Pattern&gt;%date %-5level [%thread] %logger{36} [%file:%line] %msg%n&lt;/Pattern&gt;
 *        &lt;/encoder&gt;
 *        &lt;rollingPolicy class="ch.qos.logback.core.rolling.TimeBasedRollingPolicy"&gt;
 *            &lt;FileNamePattern&gt;target/jperf.%d{yyyy-MM-dd}.log&lt;/FileNamePattern&gt;
 *        &lt;/rollingPolicy&gt;
 *    &lt;/appender&gt;
 *
 *    &lt;!-- Loggers --&gt;
 *    &lt;!--
 *      The Perf4J logger. Note that org.jperf.TimingLogger is the value of the
 *      org.jperf.StopWatch.DEFAULT_LOGGER_NAME constant. Also, note that
 *      additivity is set to false, which is usually what is desired - this means
 *      that timing statements will only be sent to this logger and NOT to
 *      upstream loggers.
 *    --&gt;
 *    &lt;logger name="org.jperf.TimingLogger" additivity="false"&gt;
 *        &lt;level value="INFO"/&gt;
