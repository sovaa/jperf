...
public class JmxAttributeStatisticsAppender extends AppenderBase<LoggingEvent> {
     ...
     * MBeanServer. If not specified, defaults to org.jperf:type=StatisticsExposingMBean,name=Perf4J.
     *
     ...
     * {@link org.jperf.helpers.StatisticsExposingMBean} for more details.
     *
