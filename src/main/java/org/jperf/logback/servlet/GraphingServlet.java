 ...
 */
package org.jperf.logback.servlet;

import java.util.ArrayList;
import java.util.List;

import org.jperf.chart.StatisticsChartGenerator;

import org.jperf.servlet.AbstractGraphingServlet;

import org.jperf.logback.GraphingStatisticsAppender;


/**
 * This graphing servlet implementation looks for graphs from {@link org.jperf.logback.GraphingStatisticsAppender}s that
...
public class GraphingServlet extends AbstractGraphingServlet {
     ...
     * {@link org.jperf.logback.GraphingStatisticsAppender#getAppenderByName(String)} method to find the appender with
     * the specified name.
     *
