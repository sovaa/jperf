...
public class LoggingStopWatch extends StopWatch {
     ...
     * {@link org.jperf.log4j.JmxAttributeStatisticsAppender} in the logging configuration to be notified when
     ...
     * @see org.jperf.log4j.JmxAttributeStatisticsAppender#getNotificationThresholds()
     */
