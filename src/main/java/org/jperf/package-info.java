 ...
 * // to the logging framework of your choice, like a {@link org.jperf.log4j.Log4JStopWatch} or an {@link org.jperf.slf4j.Slf4JStopWatch}.
 * {@link org.jperf.StopWatch} stopWatch = new {@link org.jperf.LoggingStopWatch}("tagName");
 * ... some code ...
 * stopWatch.stop(); // jperf lets you use the logging framework of your choice
 * </pre>
 * To analyze the logged timing statements you run the log output file through the {@link org.jperf.LogParser},
 ...
 * yet available, to be completed in the next revision of Perf4J). See the {@link org.jperf.log4j} and
 * {@link org.jperf.javalog} packages for more information.
 * <p>
 * In addition, many developers will find it most useful to use Perf4J's profiling annotations in the
 * {@link org.jperf.aop} package instead of inserting timing statements directly in code.
