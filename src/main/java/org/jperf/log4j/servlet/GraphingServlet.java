 ...
 */
package org.jperf.log4j.servlet;

import org.jperf.chart.StatisticsChartGenerator;
import org.jperf.log4j.GraphingStatisticsAppender;
...
/**
 * This graphing servlet implementation looks for graphs from {@link org.jperf.log4j.GraphingStatisticsAppender}s that
...
public class GraphingServlet extends AbstractGraphingServlet {
     ...
     * {@link org.jperf.log4j.GraphingStatisticsAppender#getAppenderByName(String)} method to find the appender with
     * the specified name.
     *
