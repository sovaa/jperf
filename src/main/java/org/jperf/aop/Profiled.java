 ...
 *
 * @see <a href="http://jperf.codehaus.org/devguide.html#Adding_the_Profiled_Annotation_to_Method_Declarations">The Perf4J Developer Guide Profiled Annotations Overview</a>
 * @author Alex Devine
 */
...
public @interface Profiled {
    ...
    /**
     * The tag that should be set on the {@link org.jperf.StopWatch} when the execution time is logged. If not
    ...
    /**
     * The optional message element can be used to set a message on the {@link org.jperf.StopWatch} that is logged.
     *
     ...
     * use to log the {@link org.jperf.StopWatch}.
     *
