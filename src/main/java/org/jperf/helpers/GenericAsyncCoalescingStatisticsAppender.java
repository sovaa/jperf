 ...
 *
 * @see org.jperf.log4j.AsyncCoalescingStatisticsAppender
 */
public class GenericAsyncCoalescingStatisticsAppender {
     ...
     * org.jperf.helpers.StopWatchParser
     */
     ...
     * into StopWatch instances. This defaults to the standard "org.jperf.helpers.StopWatchParser" class.
     *
    ...
    public void start(GroupedTimingStatisticsHandler handler) {
        ...
        drainingThread = new Thread(new Dispatcher(), "jperf-async-stats-appender-sink-" + getName());
