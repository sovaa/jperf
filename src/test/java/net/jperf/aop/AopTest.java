...
/**
 * Tests the Aspect Oriented Programming support provided by jperf utilizing AspectJ AOP.
 */
public class AopTest extends TestCase {
    ...
    public void testAspects() throws Exception {
        ...
        assertTrue("Expected tag not found in " + InMemoryTimingAspect.getLastLoggedString(),
                   InMemoryTimingAspect.getLastLoggedString().indexOf("tag[expressionTest_net.jperf.aop.ProfiledObject#simpleTestWithJexlTagAndMessageClassMethod]") >= 0);
        assertTrue("Expected message not found in " + InMemoryTimingAspect.getLastLoggedString(),
        ...
        assertTrue("Expected tag not found in " + InMemoryTimingAspect.getLastLoggedString(),
                InMemoryTimingAspect.getLastLoggedString().indexOf("tag[net.jperf.aop.ProfiledObject#simpleTestDefaultTagMessageFromPropertiesJexl]") >= 0);
        assertTrue("Expected tag not found in " + InMemoryTimingAspect.getLastLoggedString(),
