...
public class Slf4JStopWatchTest extends LoggingStopWatchTest {
    ...
    protected void customTests() {
        Slf4JStopWatch stopWatch = new Slf4JStopWatch(0L, 1000L, "tag", "message",
                                                      LoggerFactory.getLogger("net.jperf"),
        ...
        assertEquals(LoggerFactory.getLogger("net.jperf"), stopWatch.getLogger());
        ...
        stopWatch.setLogger(LoggerFactory.getLogger("net.jperf.AnotherTestLogger"));
        assertEquals(LoggerFactory.getLogger("net.jperf.AnotherTestLogger"), stopWatch.getLogger());
