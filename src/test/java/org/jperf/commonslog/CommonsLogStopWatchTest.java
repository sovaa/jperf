...
public class CommonsLogStopWatchTest extends LoggingStopWatchTest {
    ...
    protected void customTests() {
        ...
        assertEquals(LogFactory.getLog("org.jperf"), stopWatch.getLogger());
        ...
        stopWatch.setLogger(LogFactory.getLog("org.jperf.AnotherTestLogger"));
        assertEquals(LogFactory.getLog("org.jperf.AnotherTestLogger"), stopWatch.getLogger());
