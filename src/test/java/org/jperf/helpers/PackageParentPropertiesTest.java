...
public class PackageParentPropertiesTest extends TestCase {
    ...
    public void testParentPath() {
        assertEquals("parent tag", properties.get("tag.org.jperf.helpers.ClassNotInProperties"));
        assertEquals("parent message", properties.get("message.org.jperf.helpers.ClassNotInProperties"));
    }

    public void testParentPathGetProperty() {
        assertEquals("parent tag", properties.getProperty("tag.org.jperf.helpers.ClassNotInProperties"));
        assertEquals("parent message", properties.getProperty("message.org.jperf.helpers.ClassNotInProperties"));
    }
