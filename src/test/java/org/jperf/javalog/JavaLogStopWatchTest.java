 ...
 */
package org.jperf.javalog;

import org.jperf.LoggingStopWatch;
import org.jperf.LoggingStopWatchTest;
...
public class JavaLogStopWatchTest extends LoggingStopWatchTest {
    ...
    protected void customTests() {
        JavaLogStopWatch stopWatch = new JavaLogStopWatch(0L, 1000L, "tag", "message",
                                                          Logger.getLogger("org.jperf"), Level.FINEST, Level.INFO);
        ...
        assertEquals("org.jperf", stopWatch.getLogger().getName());
        assertEquals(Level.FINEST, stopWatch.getNormalPriority());
        assertEquals(Level.INFO, stopWatch.getExceptionPriority());

        stopWatch.setLogger(Logger.getLogger("org.jperf.AnotherTestLogger"));
        assertEquals("org.jperf.AnotherTestLogger", stopWatch.getLogger().getName());
        ...
        Logger.getLogger("org.jperf.AnotherTestLogger").setLevel(Level.FINEST);
        assertTrue(stopWatch.isLogging());
        Logger.getLogger("org.jperf.AnotherTestLogger").setLevel(Level.INFO);
