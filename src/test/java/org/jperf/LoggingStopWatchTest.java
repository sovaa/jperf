...
public class LoggingStopWatchTest extends TestCase {
    ...
    public void testStopWatch() throws Exception {
        ...
        checkProperties(createStopWatch("org.jperf.TestLogger", null, null, null, null),
                        "org.jperf.TestLogger", "INFO", "WARN", "", null);
        checkProperties(createStopWatch("org.jperf.TestLogger", "DEBUG", null, null, null),
                        "org.jperf.TestLogger", "DEBUG", "WARN", "", null);
        checkProperties(createStopWatch("org.jperf.TestLogger", "DEBUG", "ERROR", null, null),
                        "org.jperf.TestLogger", "DEBUG", "ERROR", "", null);
        checkProperties(createStopWatch("org.jperf.TestLogger", null, null, "taga", null),
                        "org.jperf.TestLogger", "INFO", "WARN", "taga", null);
        checkProperties(createStopWatch("org.jperf.TestLogger", "DEBUG", null, "tagb", null),
                        "org.jperf.TestLogger", "DEBUG", "WARN", "tagb", null);
        checkProperties(createStopWatch("org.jperf.TestLogger", "DEBUG", "ERROR", "tagc", null),
                        "org.jperf.TestLogger", "DEBUG", "ERROR", "tagc", null);
        checkProperties(createStopWatch("org.jperf.TestLogger", null, null, "taga", "m1"),
                        "org.jperf.TestLogger", "INFO", "WARN", "taga", "m1");
        checkProperties(createStopWatch("org.jperf.TestLogger", "DEBUG", null, "tagb", "m2"),
                        "org.jperf.TestLogger", "DEBUG", "WARN", "tagb", "m2");
        checkProperties(createStopWatch("org.jperf.TestLogger", "DEBUG", "FATAL", "tagc", "m3"),
                        "org.jperf.TestLogger", "DEBUG", "FATAL", "tagc", "m3");

        checkSerializationAndCloning(createStopWatch("org.jperf.TestLogger", "DEBUG", "WARN", "tagd", "m4"));
