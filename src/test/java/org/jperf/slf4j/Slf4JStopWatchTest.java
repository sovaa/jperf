...
public class Slf4JStopWatchTest extends LoggingStopWatchTest {
    ...
    protected void customTests() {
        Slf4JStopWatch stopWatch = new Slf4JStopWatch(0L, 1000L, "tag", "message",
                                                      LoggerFactory.getLogger("org.jperf"),
        ...
        assertEquals(LoggerFactory.getLogger("org.jperf"), stopWatch.getLogger());
        ...
        stopWatch.setLogger(LoggerFactory.getLogger("org.jperf.AnotherTestLogger"));
        assertEquals(LoggerFactory.getLogger("org.jperf.AnotherTestLogger"), stopWatch.getLogger());
