...
public class AopTest extends TestCase {
    ...
    public void testAspects() throws Exception {
        ...
        assertTrue("Expected tag not found in " + InMemoryTimingAspect.getLastLoggedString(),
                   InMemoryTimingAspect.getLastLoggedString().indexOf("tag[expressionTest_org.jperf.aop.ProfiledObject#simpleTestWithJexlTagAndMessageClassMethod]") >= 0);
        assertTrue("Expected message not found in " + InMemoryTimingAspect.getLastLoggedString(),
        ...
        assertTrue("Expected tag not found in " + InMemoryTimingAspect.getLastLoggedString(),
                InMemoryTimingAspect.getLastLoggedString().indexOf("tag[org.jperf.aop.ProfiledObject#simpleTestDefaultTagMessageFromPropertiesJexl]") >= 0);
        assertTrue("Expected tag not found in " + InMemoryTimingAspect.getLastLoggedString(),
